...
//        <div className="flex items-center justify-center w-24 h-16 bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 p-2 transition-transform hover:scale-105">
//         <img 
//           src="/assests/images/miniLogo.png" 
//           alt="FinFlow Logo" 
