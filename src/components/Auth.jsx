...
// Importing Sub-Components from the same folder
...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-4 transition-all">
      <div className="w-full max-w-md space-y-8 bg-white dark:bg-slate-900 p-8 rounded-[32px] shadow-2xl border border-gray-100 dark:border-white/5 relative overflow-hidden">
        ...
        <div className="text-center relative">
          ...
          <p className="text-slate-500 mt-2 font-medium text-sm">
            {isForgot ? 'Secure your account' : 'Master your finances today'}
          </p>
        </div>
